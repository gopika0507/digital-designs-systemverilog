...
HD_PWD='C:/Users/Gopika N/digital-designs-systemverilog/vivado/4bit_rca/4bit_rca.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rca4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rca4.tcl
